...
public class PullNewGameberryMobsOfferService implements PullOfferServiceTask {

	protected static Logger logger = Logger.getLogger(PullNewGameberryMobsOfferService.class);

	private Advertisers advertisers;

	public PullNewGameberryMobsOfferService(Advertisers advertisers) {
	...
	public static void main(String[] args) {
		...
		tmp.setApiurl("https://api-junggglex.affise.com/3.0/partner/offers?page=1&limit=1500&api-key=85abb6a8543baff4066d0990e4b9d9c0e6fb85d0");
		tmp.setApikey("b8fed406891f0ceb6fc511e7d5a0345491e59057");
		tmp.setId(1060L);

		PullNewGameberryMobsOfferService mmm = new PullNewGameberryMobsOfferService(tmp);
		mmm.run();
	}
