...
public class PullLeadboltIosOfferService implements PullOfferServiceTask{
	
	protected static Logger logger = Logger.getLogger(PullLeadboltIosOfferService.class);
	
	private Advertisers advertisers;
	
	public PullLeadboltIosOfferService(Advertisers advertisers){
	...
	public static void main(String[] args)  {
		...
		PullLeadboltIosOfferService mmm=new PullLeadboltIosOfferService(tmp);
		mmm.run();
	}
