...
public class PullEmarboxOfferService implements PullOfferServiceTask {

	protected static Logger logger = Logger
			.getLogger(PullEmarboxOfferService.class);

	private Advertisers advertisers;

	public PullEmarboxOfferService(Advertisers advertisers) {
					...
					for (int i = 0; i < offersArray.size(); i++) {
						try {
							...
							if (offerItem != null) {
								...
								String trackinglink = offerItem
										.getString(("clickUrl"));
								String platform = offerItem.getString("os");
								String icon = offerItem.getString("icon");
								String pkg = offerItem.getString("packageName");
								String previewlink = offerItem
										.getString("previewLink");
								String descriptionInfo = offerItem
