...
public class PullMobairsIOSOfferService implements PullOfferServiceTask{
	
	protected static Logger logger = Logger.getLogger(PullMobairsIOSOfferService.class);
	
	private Advertisers advertisers;
	
	public PullMobairsIOSOfferService(Advertisers advertisers){
	...
	public void run(){
		...
		synchronized(this){
			...
			logger.info("doPull Mobairs IOS Offer begin := " + new Date());
...
//							}
	...
	public static void main(String[] args)  {
		...
		PullMobairsIOSOfferService mmm=new PullMobairsIOSOfferService(tmp);
		mmm.run();
	}
