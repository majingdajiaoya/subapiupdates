...
public class PullSurmobisOfferService3 implements PullOfferServiceTask{
	
	protected static Logger logger = Logger.getLogger(PullSurmobisOfferService3.class);
	
	private Advertisers advertisers;
	
	public PullSurmobisOfferService3(Advertisers advertisers){
	...
	public void run(){
		...
		synchronized(this){
			...
			logger.info("doPull Surmobi3 Offer begin := " + new Date());
...
//							}
	...
	public static void main(String[] args)  {
		...
		tmp.setApiurl("http://api.aubemobile.com/api/offer/v2.0/?token={apikey}&os=1,2&is_incent=0,1&limit=200");
		tmp.setApikey("eba56face3724ce2bd9995e882d2f9f6");
		tmp.setId(21L);
		
		//&placement={sub_affid}&subid1={aff_sub}
		PullSurmobisOfferService3 mmm=new PullSurmobisOfferService3(tmp);
		mmm.run();
	}
