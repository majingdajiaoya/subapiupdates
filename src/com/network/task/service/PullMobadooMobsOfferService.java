...
public class PullMobadooMobsOfferService implements PullOfferServiceTask{
	
	protected static Logger logger = Logger.getLogger(PullMobadooMobsOfferService.class);
	
	private Advertisers advertisers;
	
	public PullMobadooMobsOfferService(Advertisers advertisers){
	...
	public void run(){
		...
		synchronized(this){
			...
			logger.info("doPull Mobadoo Offer begin := " + new Date());
...
//							}
							...
							if (os_str.equals("0")) { //android
								link=link+"&subid5=com.hsgame.FightingKing_KungfuClash.gp";
							} else if (os_str.equals("1")) { //ios
								link=link+"&subid5=1146128499";
							}
							...
							if (payments!= null &&payments.size() >0) {
								...
								String currency = paymentsitem.getString("currency");
...
//							}
	...
	public static void main(String[] args)  {
		...
		//http://api.mobadoo.affise.com/3.0/partner/offers?api-key=eed630280295c59b9e8b10ae9e067ea5e2c7ebb5&limit=500
		//http://api.mobadoo.affise.com/3.0/partner/offers?api-key={apikey}&limit=500
		
		tmp.setApiurl("http://api.mobadoo.affise.com/3.0/partner/offers?api-key={apikey}&limit=500");
		tmp.setApikey("eed630280295c59b9e8b10ae9e067ea5e2c7ebb5");
		tmp.setId(25L);
		
		//&sub1={aff_sub}&sub2={sub_affid}&sub3={gaid}&sub4={idfa}
		
		PullMobadooMobsOfferService mmm=new PullMobadooMobsOfferService(tmp);
		mmm.run();
	}
