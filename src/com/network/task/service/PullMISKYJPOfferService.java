...
public class PullMISKYJPOfferService implements PullOfferServiceTask {

	protected static Logger logger = Logger.getLogger(PullMISKYJPOfferService.class);

	private Advertisers advertisers;

	public PullMISKYJPOfferService(Advertisers advertisers) {
					...
					for (int i = 0; i < offersArray.size(); i++) {
						try {
							...
							if (offerItem != null) {
								...
								Float payout = payouts.getFloat("US");
	...
	public static void main(String[] args) {
		...
		tmp.setApiurl("http://api.misky-ads.com/?version=1&apikey={apikey}&c=api.get_offers&payout_model=CPI&limit=1000&my_offers=1");
		tmp.setApikey("bdd19ae20d2db3d50daeabdc0f675e61c54d1655476e29ddf04fe48aea1588c7");
		tmp.setId(1063L);
		
		PullMISKYJPOfferService mmm=new PullMISKYJPOfferService(tmp);
		mmm.run();
	}
