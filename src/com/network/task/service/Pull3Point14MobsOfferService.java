...
public class Pull3Point14MobsOfferService implements PullOfferServiceTask {

	protected static Logger logger = Logger.getLogger(Pull3Point14MobsOfferService.class);

	private Advertisers advertisers;

	public Pull3Point14MobsOfferService(Advertisers advertisers) {
	...
	public static void main(String[] args) {
		...
		tmp.setApiurl("http://api.3point14.affise.com/3.0/partner/offers?api-key={apikey}&limit=500");
		tmp.setApikey("980726e43b06c20c12b878e3b1f49e3b9ae01fde");
		tmp.setId(1078L);
		Pull3Point14MobsOfferService mmm = new Pull3Point14MobsOfferService(tmp);
		mmm.run();
	}
