...
public class PullAvazuOfferService implements PullOfferServiceTask {

	protected static Logger logger = Logger.getLogger(PullAvazuOfferService.class);

	private Advertisers advertisers;

	public PullAvazuOfferService(Advertisers advertisers) {
