...
public class PullMobriderMobsOfferService implements PullOfferServiceTask {

	protected static Logger logger = Logger
			.getLogger(PullMobriderMobsOfferService.class);

	private Advertisers advertisers;

	public PullMobriderMobsOfferService(Advertisers advertisers) {
	...
	private static int getTotalPages(String offerUrl) {
		try {
			...
			Integer page = json.getInteger("count_pages");
			return page;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	public static void main(String[] args) {
		...
		try {
			String offerUrl = "https://api.mobrider.com/v2/affiliate/offer/findAll/?token=eoo5T1wwu7cEi6iomFQoJr8mU5Z4EqPq";
			String str = HttpUtil.sendGet(offerUrl);
			JSONObject json = JSON.parseObject(str);
...
//		tmp.setApiurl("http://api.3point14.affise.com/3.0/partner/offers?API-Key={apikey}&limit=500&page={page}");
//		tmp.setApikey("980726e43b06c20c12b878e3b1f49e3b9ae01fde");
//		tmp.setId(1068L);
//		PullMobriderMobsOfferService mmm=new PullMobriderMobsOfferService(tmp);
//		mmm.run();
	}
