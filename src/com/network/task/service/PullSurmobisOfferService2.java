...
public class PullSurmobisOfferService2 implements PullOfferServiceTask{
	
	protected static Logger logger = Logger.getLogger(PullSurmobisOfferService2.class);
	
	private Advertisers advertisers;
	
	public PullSurmobisOfferService2(Advertisers advertisers){
...
//							}
	...
	public static void main(String[] args)  {
		...
		PullSurmobisOfferService2 mmm=new PullSurmobisOfferService2(tmp);
		mmm.run();
	}
