...
public class PullMISKYUSOfferService implements PullOfferServiceTask {

	protected static Logger logger = Logger.getLogger(PullMISKYUSOfferService.class);

	private Advertisers advertisers;

	public PullMISKYUSOfferService(Advertisers advertisers) {
