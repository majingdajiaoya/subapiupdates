...
public class TTTTT implements PullOfferServiceTask {

	protected static Logger logger = Logger.getLogger(PullInmobi2OfferService.class);

	private Advertisers advertisers;

	public TTTTT(Advertisers advertisers) {
	...
	public void run() {
		...
		synchronized (this) {
			...
			try {
				...
				header2.put("secretKey", apikey);
				header2.put("userName", "chris@interestmob.com");
				header2.put("password", "Interest@2018");
	...
	public static void main(String[] args) throws ClientProtocolException, IOException {
		String apiurl="https://item-api.aff-adeals.com/api/v2/get_campaigns?_page=1&_per=2";
		Map<String, String> header = new HashMap<String, String>();
//		Bearer XXXXXXX' -d'_page=1&_per=2
		header.put("Authorization", "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1ODM0MDI4MTIsInNpdGVfaWQiOjM2MH0.SHU2FMz8xyEQBnI0HIZw70duw5wlchVOKwUhlFaMhaU");

			String jsonStr = HttpUtil.execCurl(apiurl, header);
