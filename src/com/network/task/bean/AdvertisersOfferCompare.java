...
public class AdvertisersOfferCompare extends AdvertisersOfferTemp {
	...
	private Date ctime;
	private Date utime;
	private String impress_url;
	private String limit_os;
	...
	public String getImpress_url() {
		return impress_url;
	}

	public void setImpress_url(String impress_url) {
		this.impress_url = impress_url;
	}
