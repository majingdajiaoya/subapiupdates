 ...
 * 
 */
public class AdvertisersOfferForUpdate {

	private Long id;
	private String adv_offer_id;// 网盟自身offer ID
	private String name;// 网盟offer名称
	private Integer cost_type;// Offer转化类型(0:CPI、1:CPA、2:CPS等)
	private Integer offer_type;// Offer业务分类(0:GP-CPI 1:订阅 2:国内IOS 3:五类)
	...
	private Integer old_daily_cap;// 更新前广告每日cap限制
	private Integer send_cap;// 下发渠道cap限制
	private Float payout;// 支付价格
	private Float old_payout;// 更新前广告价格
	...
	public Integer getOld_daily_cap() {
		return old_daily_cap;
	}

	public void setOld_daily_cap(Integer old_daily_cap) {
		this.old_daily_cap = old_daily_cap;
	}

	public Float getOld_payout() {
		return old_payout;
	}

	public void setOld_payout(Float old_payout) {
		this.old_payout = old_payout;
	}
